    ...
    <div>
      <header className="bg-secondary grid h-16 w-full max-w-[1920px] grid-cols-3 items-center max-[850px]:grid-cols-2">
        ...
        <nav className="flex w-full justify-center gap-12 max-[850px]:hidden">
          ...
          <NavMainButton id="preview" label="Preview" active={active} onScroll={scrollToSection} />
          <NavMainButton id="remixes" label="Remixes" active={active} onScroll={scrollToSection} />
          <NavMainButton
            id="filosofia"
            label="Filosofía"
            active={active}
