...
export default function Hero() {
  return (
    <section className="flex h-screen max-w-[1280px] max-[1280px]:mx-6 min-[1280px]:mx-auto">
      <div className="mt-44 flex flex-col gap-4 text-left">
        ...
        <p className="font-secondary w-2/4 text-8xl">
          El Futuro se Construye con <span className="text-amber-800 italic">Intención</span>.
        </p>
        <div className="font-primary mt-3 text-sm">
          <p className="text-neutral w-lg text-lg">
        ...
        <div className="font-secondary mt-7 flex gap-6">
          <Button size="lg" className="text-primary rounded-lg bg-black">
            INICIAR
          </Button>
